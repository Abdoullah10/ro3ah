      ...
      <div className="flex flex-col items-center py-10 space-y-16">
        ...
        <div className="flex flex-row-reverse  text-center px-28 justify-between space-x-5 w-full">
          <div className="flex flex-col    items-center">
            <Lord icon="star" /><br />
            <h1 className="font-mont font-semibold text-2xl">السهولة</h1><h1 className="mt-2 font-mont font-medium text-lg" >بخطوات بسيطة يمكنك إنشاء إعلانك لطلب <br />الرعاية</h1>
            </div>
          <div className="flex flex-col    items-center"><Lord icon="star" /><br /><h1 className="font-mont font-semibold text-2xl">الشفافية</h1><h1 className="mt-2 font-mont font-medium text-lg">تواصل مع الرعاة بشكل مباشر وبدون وجود<br />وسطاء وبدون عمولة</h1></div>
          <div className="flex flex-col    items-center"><Lord icon="puzzle" /><br /><h1 className="font-mont font-semibold text-2xl">الانتشار</h1><h1 className="mt-2 font-mont font-medium text-lg"> لك وصول اعلانك لأكبر عدد ممكن من<br />الرعاة المحتملين</h1></div>
        </div>
